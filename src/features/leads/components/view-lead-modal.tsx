              ...
              <div className='space-y-2'>
                ...
                {lead.contact.phone && (
                  <div className='flex items-center space-x-2 text-sm'>
                    ...
                    <a href={`tel:${lead.contact.phone}`} className='text-blue-600 hover:underline'>
                      {lead.contact.phone}
                    </a>
                  </div>
                )}
                ...
                {lead.contact.address && (
                  <div className='flex items-start space-x-2 text-sm'>
                    ...
                    <div>
                      ...
                      <p className='text-muted-foreground'>{lead.contact.address}</p>
                    </div>
                  </div>
                )}
              ...
              <div>
                ...
                <div className='space-y-2'>
                  <div className='flex items-start space-x-2 text-sm'>
                    <MapPin className='h-4 w-4 text-muted-foreground mt-0.5' />
                    <div>
                      <p className='font-medium'>{lead.property.shortAddress || lead.property.address}</p>
                      {lead.property.unit && (
                        <p className='text-muted-foreground'>Unit {lead.property.unit}</p>
                      )}
                  ...
                  {lead.startTime && (
                    <div className='flex items-center space-x-2 text-sm'>
                      ...
                      <span>{format(new Date(lead.startTime), 'MMM dd, yyyy HH:mm')}</span>
                    </div>
                  )}
                </div>
              </div>
              ...
              <div>
                ...
                <div className='space-y-2'>
                  ...
                  <div className='flex items-center space-x-2 text-sm'>
                    <Mail className='h-4 w-4 text-muted-foreground' />
                    <span className='font-medium'>Email:</span>
                    <a href={`mailto:${lead.user.email}`} className='text-blue-600 hover:underline'>
                      {lead.user.email}
                    </a>
                  </div>
            ...
            <div className='space-y-3'>
              ...
              <div className='space-y-1'>
                ...
                <div className='flex flex-wrap gap-2 pl-6'>
                  ...
                  {!lead.contact.idImage && !lead.contact.document && !lead.contact.documentBack && !lead.contact.face && (
