...
export const getStructureTypeColor = (type: StructureType): string => {
  const colors: Record<StructureType, string> = {
    [StructureType.BUILDING]: 'bg-blue-100 text-blue-700 dark:bg-blue-900 dark:text-blue-300',
    [StructureType.FLOOR]: 'bg-green-100 text-green-700 dark:bg-green-900 dark:text-green-300',
    [StructureType.ROOM]: 'bg-purple-100 text-purple-700 dark:bg-purple-900 dark:text-purple-300',
    [StructureType.COMPLEX]: 'bg-orange-100 text-orange-700 dark:bg-orange-900 dark:text-orange-300',
    [StructureType.AREA]: 'bg-pink-100 text-pink-700 dark:bg-pink-900 dark:text-pink-300',
  };
